...
public class IncomeFragment extends Fragment implements AnalysisFragment.TimeChangeListener {
    ...
    private void initRecyclerView(View view){
        ...
        mAdapter = new IncomeFragment.AnalysisAdapter(getContext(), percentBarItems);
